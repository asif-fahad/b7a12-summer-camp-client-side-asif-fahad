        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                ...
                <div>
                    ...
                    <a className="link link-hover">fahad's@sports.com</a>
                    <a className="link link-hover">0150000000</a>
                </div>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <img src={logo} alt="Fahad's Toys" className='w-40' />
                    <p>Fahad's Sports <br />Providing reliable sports courses since 2023</p>
                </div>
