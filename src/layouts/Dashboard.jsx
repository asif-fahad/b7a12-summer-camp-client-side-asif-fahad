...

                        {
                            roles == "Admin" ?
                                ...
                                roles == "Instructor" ?
                                    ...
                                    <>
                                        <li><NavLink to='/dashboard/myenrolledclasess'><FaUser></FaUser>My Enrolled Classes</NavLink></li>
                                        <li><NavLink to='/dashboard/myselectedclasses'><FaUser></FaUser>My Selected Classes</NavLink></li>
